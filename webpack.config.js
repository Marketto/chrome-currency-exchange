class ChromePluginWebpack {
  constructor({ NODE_ENV } = { NODE_ENV: 'development' }) {
    ...
    const options = {
      ...
      plugins: [
        ...
        NODE_ENV === "production" && new WriteFilePlugin()
      ]
    };
...
module.exports = (...cfg) => new ChromePluginWebpack(...cfg);
